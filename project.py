...
CLIENT_ID = json.loads(
    open('/vagrant/listing-project/client_secrets.json', 'r').read())['web']['client_id']
...
def showCategories():
    ...
    return render_template("index.html", categories = cat, loginFlag = loginFlag, loggedUser = loggedUser)
